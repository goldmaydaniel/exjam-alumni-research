...
async function addPGConferenceEvent() {
  console.log("🚀 Adding President General's Conference Event...");
  ...
  try {
    ...
    console.log("\n🌐 View event at: https://exjam-alumni-j4pae05f9-gms-projects-06b0f5db.vercel.app/events");
    console.log("🏠 Check homepage: https://exjam-alumni-j4pae05f9-gms-projects-06b0f5db.vercel.app");
