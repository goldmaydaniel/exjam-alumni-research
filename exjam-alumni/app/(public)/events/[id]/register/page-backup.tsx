...
export default function EventRegistrationPage() {
  ...
  const handleRegistration = async () => {
    ...
    try {
      // For now, redirect to login page with return URL
      // This ensures users are authenticated before registration
                      ...
                      >
                        {registering ? (
                          <>
                            ...
                            <span className="hidden sm:inline">Redirecting to Login...</span>
                            <span className="sm:hidden">Loading...</span>
                          </>
                        ) : (
                          <>
                            <Ticket className="mr-2 h-4 w-4 sm:mr-3 sm:h-5 sm:w-5" />
                            <span className="hidden sm:inline">Login to Register</span>
